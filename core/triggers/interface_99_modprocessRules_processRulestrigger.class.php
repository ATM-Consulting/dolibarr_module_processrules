...
/**
 * 	\file		core/triggers/interface_99_modMyodule_processRulestrigger.class.php
 * 	\ingroup	processrules
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modProcessrules_Mytrigger.class.php
 ...
 * Trigger class
 */
class InterfaceprocessRulestrigger
{
