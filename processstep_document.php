...
/**
 *  \file       processstep_document.php
 *  \ingroup    processrules
 *  \brief      Tab for documents linked to processstep
 */
...
$hookmanager->initHooks(array('processstepdocument','globalcard'));     // Note that conf->hooks_modules contains array
// Fetch optionals attributes and labels
$extralabels = $extrafields->fetch_name_optionals_label('processstep');

// Load object
include DOL_DOCUMENT_ROOT.'/core/actions_fetchobject.inc.php';  // Must be include, not include_once  // Must be include, not include_once. Include fetch and fetch_thirdparty but not fetch_optionals

if ($id > 0 || ! empty($ref)) $upload_dir = $conf->processrules->multidir_output[$object->entity?$object->entity:$conf->entity] . "/processrules/processstep/" . dol_sanitizeFileName($object->id);
...
if ($object->id)
{
	...
	dol_fiche_head($head, 'document', $langs->trans("processStep"), -1, $picto);
